    ...
    <div className="space-y-8 pb-12 selection:bg-blue-100 selection:text-blue-900">
      ...
      <div className="grid lg:grid-cols-3 gap-8 items-start">
        ...
        <aside className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-3 text-xs font-semibold text-slate-650 leading-normal">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {activeSettingsTab === "general" && (
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-6 animate-in fade-in duration-200">
              <h3 className="text-sm font-bold text-slate-800 font-semibold">General Information</h3>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isSelected
                          ...
                          : "bg-white text-slate-650 border-slate-200 hover:border-slate-355"
                      )}
                    >
                      {tag}
          ...
          {activeSettingsTab === "notifications" && (
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4 animate-in fade-in duration-200">
              <h3 className="text-sm font-bold text-slate-800 font-semibold">Notification Alerts</h3>

              <div className="space-y-4 divide-y divide-slate-55">
                {[
          ...
          {activeSettingsTab === "privacy" && (
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4 animate-in fade-in duration-200">
              ...
              <div className="grid sm:grid-cols-2 gap-4 text-xs font-semibold text-slate-605">
